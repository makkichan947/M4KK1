/**
 * M4KK1 ARM Architecture - Main Kernel Implementation
 * ARM架构主内核实现 - 独特的M4KK1内核入口点 (32位)
 *
 * 文件: kmain.c
...
void kmain(uint64_t magic, uint64_t multiboot_addr) {
    ...
    console_write("=====================================\n");
    console_write("    M4KK1 ARM Kernel Starting...\n");
    console_write("=====================================\n");
    ...
    /* 显示内核信息 */
    console_write("M4KK1 ARM Kernel v0.2.0-multarch\n");
    console_write("Architecture: ARM (32-bit)\n");
    console_write("Build: ");
    ...
    console_write("=====================================\n");
    console_write("M4KK1 ARM Kernel Ready!\n");
    console_write("=====================================\n");
...
void m4k_arch_init(void) {
    /* ARM特定初始化 */
    console_write("Initializing ARM architecture...\n");

    /* 检测CPU特性 */
    m4k_arch_detect_features();

    console_write("ARM architecture initialized\n");
}